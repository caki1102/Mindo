...
tell application "Calendar"
  ...
  set newEvent to make new event at end of events of targetCalendar with properties {summary:${appleScriptString(event.title || "MindMap Todo")}, start date:startDate, end date:endDate, description:${appleScriptString(event.notes || event.description || "")}}
  ...
  repeat with eachCalendar in calendars
    repeat with eachEvent in events of eachCalendar
      if uid of eachEvent is targetUid then
        set summary of eachEvent to ${appleScriptString(event.title || "MindMap Todo")}
